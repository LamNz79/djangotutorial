...
## Background
DL-01 requires the BFF to include the current user’s vote state when fetching
question details. Django exposes vote mutation endpoints but did not expose
a query endpoint for retrieving a user’s vote for a question.

---

## Problem
There was no Django API to:
- retrieve a user’s vote
...
**Q4: What response should indicate “not voted”?**  
...
- 404 used to represent “not voted”
